...
def download_supervision_scale_api(request):
    ...
    with transaction.atomic():
        ...
        filename = f'Escala_Supervisão_{referral.patient.name}.pdf'
        response = FileResponse(referral.supervision_scale, content_type='application/pdf')
